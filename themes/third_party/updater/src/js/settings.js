;(function(global, $){
    ...
    function checkLogin(){
        ...
        for (var key in params) {
            inputs.push({name:key, value:params[key]});
        }

        inputs.push({name:'task', value:'test_login'});
    ...
    function getServerInfo(){
        var params = Updater.getDefaultParams(true);
        params.task = 'get_server_info';

        $.ajax({
            url: Updater.SITE_URL,
